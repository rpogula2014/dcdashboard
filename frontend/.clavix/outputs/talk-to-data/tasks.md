...
**Updated**: 2025-12-08 - Added invoice_lines table to DuckDB for receivables data
...
- [x] Create data loader to populate DuckDB with Invoice Lines on app load
  Task ID: phase-1-setup-infrastructure-5b
  File: `src/services/duckdb/dataLoaders.ts`
  Note: Added 2025-12-08 - invoice_lines table with schema for receivables data
...
- [x] Column descriptions for Invoice Lines schema context
  Task ID: phase-2-nl-to-sql-engine-2b
  File: `src/services/duckdb/dataLoaders.ts` (generateSchemaDescription function)
  Note: Added 2025-12-08 - invoice_lines table schema for LLM prompts
...
**Progress: 79% complete (55/70 tasks)**
